...
export const Header = () => {
    ...
    return (
        <header className='app-header relative gap-[1rem] h-20 w-full bg-gray-100 py-2 px-12 max-sm:px-5 flex justify-between items-center text-black z-10'>
            <Link to="/">
            ...
            <div className=" w-full flex justify-between items-center max-md:justify-end">
                ...
                <div className="gap-[1rem] flex justify-between items-center">
                    <div className="min-w-[110px] font-medium max-sm:hidden">
                    ...
                    <button className="max-sm:hidden min-w-[100px] flex gap-1.5 justify-center items-center bg-button-color hover:bg-button-color-hover py-[14px] px-[5px] text-sm text-white rounded"><RiFileUserLine />Book a Call</button>
